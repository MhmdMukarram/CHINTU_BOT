...
module.exports = {
    ...
    PHONE: process.env.NUMBER === undefined ? '+94740979220' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Red Alpha' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By RED ALPHA' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.ibb.co/JjmP8K2/LOGO.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '94740979220@s.whatsapp.net' : process.env.TAG_REPLY,
